          ...
          <div className="row">
            <div className="col-11 col-md-12 mx-auto">
              <h2 className="text-center fw-bold mb-2">
                Start a group on ENDALGO
              </h2>
              <h6 className="underHead text-center">
                Start managing your organizations or sharing what you love with
                your community. ENDALGO is dedicated to helping you connect with
                people through sports and outdoor activities.
              </h6>
