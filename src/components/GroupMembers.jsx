...
const GroupMembers = () => {
  ...
  return (
		<div className="groupMembers whyEndalgo w-100">
			<div className="page_container">
				<div className="container-fluid">
					<div className="row">
						<div className="col-11 col-md-12 mx-auto">
							<h6 className="short_head">Group members</h6>
							<div className="mt-2 mb-4">
								<h2 className="main_head fw-bold mb-0">
									People join ENDALGO groups to do outdoor activities,
								</h2>
								<h2 className="main_head fw-bold mb-2 mb-md-5">
