...
const GetStarted = () => {
  ...
  return (
		<div>
			<div className="groupMembers getStarted w-100">
				<div className="page_container">
					<div className="container-fluid">
						<div className="row">
							<div className="col-11 col-md-12 mx-auto">
								<h2 className="text-center fw-bold">How to get started</h2>
									...
									{data.map((prev, i) => {
										...
										return (
											<div key={i} className="col-12 col-md-6 mt-4 mt-md-0">
												<div className="groupMCont bg-white border-1 border border-blue rounded-3 d-flex">
