					...
					<div className="row">
						<div className="col-12 col-md-6 pe-3 pe-md-5 align-self-center">
							...
							<h6 className="centerPara">
								Simply start your group with the ENDALGO aoo for free. ENDALGO
							...
							<div className="points">
								...
								<p className="mb-0 d-flex">
									...
									<span>
										...
										interest with you. or simply add members with their email
										address.
									</span>
								</p>
								<p className="mb-0 d-flex">
									...
									<span>
										...
										registrations, and host events.
									</span>
								</p>
							</div>
							<button className="bg-transparent border-0 redColor h6 fw-bold">
								Learn about features <IoIosArrowForward />
							</button>
						</div>
						<div className="col-12 col-md-6 align-self-center ps-3 ps-md-4">
